...
namespace Umbraco.Community.OEmbed.Indiveo.Tests
{
    public class TestableIndiveoEmbedProvider : IndiveoEmbedProvider
    {
        ...
        public override T? GetJsonResponse<T>(string url) where T : class
        {
    ...
    {
        [Fact]
        public void GetMarkupAsync_ReturnsHtml_FromFakeResponse()
        {
            ...
            var markup = provider.GetMarkup("https://indiveo.services/embed/f1557bd7-1584-495a-aecd-827189d6a471", 400, 600);
